...
def args_init():
    ...
    parser.add_argument('--ckpt', type=str, default='BCNet.pth', help='Path to the model checkpoint')
...
def generator(args):
    ...
    for i, data in enumerate(dataloader):
        ...
        with torch.no_grad():
            output = net(img).cpu().detach().numpy().squeeze()
